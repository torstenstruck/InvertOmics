...
#SBATCH --job-name=Ga88_MitoHifi
#SBATCH --output=Ga88_MitoHifi_slurm-%j.txt
...
singularity exec -H $PWD:/home -B $PWD:/data/ /storage/EBPNor_pipeline/MitoHifi/MitoHifi.sif mitohifi.py -r /data/Ga88_allHifireads.fasta  -f /data/Ga52_COX1start.fas -g /data/Ga52_COX1start_annotation.gb -p 95 -a animal -t 32 -o 5
