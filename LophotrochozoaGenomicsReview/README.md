# Progress and challenges in phylogenomics and genomics of Lophotrochozoa (also known as Spiralia) 
This folder contains the scripts used for the analyses conducted as part of the review on genomics in Lophotrochozoa. More details can be found in the paper itself.
