...
### Usage of pipeline ###
# sh AssemblyHifiAsm_QualityAssessment_v2.1.sh [Name of fastq file] [Name of barcode file] [e value] [Maximum number of hits] [Maximum number of threads] [RAM for Merquery analysis] [Genome size] > AssemblyHifiAsm_QualityAssessment_Pipeline.out
#
...
#
# example of usage: sh AssemblyHifiAsm_QualityAssessment_v2.1.sh seqdata.fastq Query_Polychaeta_ProtMito.fasta 1e-20 1 64 1T 926M > AssemblyHifiAsm_QualityAssessment_Pipeline.out
#
...
echo -e "sh AssemblyHifiAsm_QualityAssessment_v2.0.sh ${FASTQ} ${BARCODE} ${EVALUE} ${MAXHITS} ${THREADS} ${MEMORY} ${GENOMESIZE}" >> AssemblyHifiAsm_QualityAssessment_Pipeline.log
...
echo -e "blobtools create --fasta ${ASM_UNPUR} BlobtoolsResults_Primary" >> ../AssemblyHifiAsm_QualityAssessment_Pipeline.log
echo -e "blobtools add --hits ${ASM_UNPUR}.blobplot.blast.out --taxrule bestsumorder --taxdump ./taxdump BlobtoolsResults_Primary" >> ../AssemblyHifiAsm_QualityAssessment_Pipeline.log
echo -e "blobtools add --cov MappedReads_${ASM_UNPUR}.sorted.bam BlobtoolsResults_Primary" >> ../AssemblyHifiAsm_QualityAssessment_Pipeline.log
echo -e "blobtools add --busco ./BUSCO_Metazoa_Primary/run_metazoa_odb10/full_table.tsv BlobtoolsResults_Primary" >> ../AssemblyHifiAsm_QualityAssessment_Pipeline.log
